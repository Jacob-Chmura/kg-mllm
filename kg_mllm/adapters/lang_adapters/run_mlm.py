...
class ModelArguments:
    ...
    config_overrides: Optional[str] = field(
        default=None,
        metadata={
            'help': 'Override default config when a model is trained from scratch.'
        },
    )
    ...
    use_fast_tokenizer: bool = field(
        default=True,
        metadata={
            'help': 'Whether to use one of the fast tokenizer (tokenizers library).'
        },
    )
    model_revision: str = field(
        default='main',
        metadata={
            'help': 'Specific model version to use (branch name, tag name, commit id).'
        },
    )
...
class DataTrainingArguments:
    ...
    validation_file: Optional[str] = field(
        default=None,
        metadata={
            'help': 'An optional input data file to evaluate perplexity on (a text file).'
        },
    )
    ...
    validation_split_percentage: Optional[int] = field(
        default=5,
        metadata={
            'help': 'Percentage of train set used as validation when no validation split'
        },
    )
    ...
    line_by_line: bool = field(
        ...
        metadata={
            'help': (
                'Whether distinct lines of text in the dataset are to be '
